    ...
    <>
      ...
      <aside className="hidden md:flex w-[60px] h-full bg-ui-bg flex-col items-center py-8 z-50">
        ...
        <div className="flex flex-col gap-1">
          {/* youtube*/}
          <a href="https://www.youtube.com/@ManyOneStudio" target="_blank" rel="noopener noreferrer" className="w-10 h-10 flex items-center justify-center rounded-lg text-white/30 hover:text-accent hover:bg-white/5 transition-all duration-300">
          ...
          {/* insta*/}
          <a href="https://www.instagram.com/manyone_studio/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 flex items-center justify-center rounded-lg text-white/30 hover:text-accent hover:bg-white/5 transition-all duration-300">
          ...
          {/* bluesky*/}
          <a href="https://bsky.app/profile/manyone-studio.bsky.social" target="_blank" rel="noopener noreferrer" className="w-10 h-10 flex items-center justify-center rounded-lg text-white/30 hover:text-accent hover:bg-white/5 transition-all duration-300">
          ...
          {/* reddit*/}
          <a href="https://www.reddit.com/user/ManyOne-Studio/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 flex items-center justify-center rounded-lg text-white/30 hover:text-accent hover:bg-white/5 transition-all duration-300">
